/*
Task. Create a large array of 107 ints, split into T segments, and sum in parallel. Combine partial
sums and compare timing with a single-threaded baseline.

Hints
Use std::accumulate for segments and std::chrono for timing. Store partials in a std::vector<long
long>.
*/
#include <iostream>
#include <vector>
